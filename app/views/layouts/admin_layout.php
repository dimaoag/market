            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?=ADMIN?>/room">Все помещения</a></li>
                        <li><a href="<?=ADMIN?>/room/floor?floor=<?= Room::FLOOR_ONE ?>">Первый этаж</a></li>
                        <li><a href="<?=ADMIN?>/room/floor?floor=<?= Room::FLOOR_TWO ?>">Второй этаж</a></li>
                        <li><a href="<?=ADMIN?>/room/floor?floor=<?= Room::FLOOR_THREE ?>">Третий этаж</a></li>
                    </ul>
                </li>
            </ul>
        </section>
